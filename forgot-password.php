...
<section class="forgot__password__container">
	...
	<article class="forgot__password ">
		...
		<form onsubmit="return false">
			...
			<input class="forgot__password__user__email" id="forgot__password_user_email" type="email" name='user_email'>
			<button class="primary__btn forgot__password__btn" onclick="sendRecoveryEmail()">Send</button>
